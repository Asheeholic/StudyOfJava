...
public class FriendGuiApp extends JFrame {
	...
	public void init() {
		...
		btnDelete.addActionListener(new ActionListener() { // 익명개체
			public void actionPerformed(ActionEvent e) {
				delete();
			}});
		btnSelectAll.addActionListener( e -> selectAll() ); // 람다식(오버라이딩 메소드가 단 하나일때)
		btnFindName.addActionListener( e -> findName() ); // 매개변수
	}
